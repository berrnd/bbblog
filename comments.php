...
<?php if ( !independent_publisher_hide_comments() ) : ?>
	...
	<div id="comments" class="comments-area">
		...
		<?php if ( count( $wp_query->comments_by_type['pings'] ) ) { ?>
			<div id="pinglist">
				<ul class="pinglist">
					<li class="pinglist-title"><?php echo apply_filters( 'independent_publisher_pingslist_title', __( 'Dieser Beitrag wurde in folgenden anderen Beiträgen erwähnt', 'independent-publisher' ) ); ?></li>
